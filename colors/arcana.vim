...
hi Bold guifg=#dca561 guibg=NONE gui=bold cterm=bold
hi Italic guifg=#e6c384 guibg=NONE gui=italic cterm=italic
...
hi DiagnosticOk guifg=#a3d4d5 guibg=NONE gui=NONE cterm=NONE
...
hi DiagnosticUnderlineOk guifg=NONE guibg=NONE guisp=#a3d4d5 gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
...
hi DiagnosticVirtualTextHint guifg=#4d699b guibg=NONE gui=NONE cterm=NONE
...
if get(g:, 'arcana_extend_ts', has('nvim'))
  ...
  hi! link @markup.link.label Define
  hi! link @markup.list Operator
  hi! link @markup.list.checked Boolean
endif
...
if s:t_Co >= 256
  ...
  hi Bold ctermfg=179 ctermbg=NONE cterm=bold
  hi Italic ctermfg=222 ctermbg=NONE cterm=italic
  ...
  hi DiagnosticOk ctermfg=152 ctermbg=NONE cterm=NONE
  ...
  hi DiagnosticVirtualTextHint ctermfg=60 ctermbg=NONE cterm=NONE
  hi! link DiagnosticVirtualLinesError DiagnosticVirtualTextError
  hi! link DiagnosticVirtualLinesWarn DiagnosticVirtualTextWarn
  hi! link DiagnosticVirtualLinesInfo DiagnosticVirtualTextInfo
  hi! link DiagnosticVirtualLinesHint DiagnosticVirtualTextHint
